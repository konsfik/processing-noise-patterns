...
public class HeightMap{
  ...
  private int _seamlessOffsetPixels;
  ...
  public HeightMap(
    ...
    _seamlessOffsetPixels = seamlessOffsetPixels;
  ...
  public void PowerSelf(float power){
    SetRange(0,1);
    for(int i = 0; i < _cells.length; i++){
      _cells[i] = (float)Math.pow(_cells[i],power);
    }
  }
